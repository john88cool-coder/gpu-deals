...
роль та же, что у Kaspi: эталон рынка, а не источник алертов (ALERT_SOURCE =
False). Ценой берём нижнюю границу диапазона — это рыночный минимум.

Строки каталога — `<tr class="model-short-row">` с партномером в `data-idgood`.
"""
